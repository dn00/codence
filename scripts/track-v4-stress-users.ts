import { TRACK_V4_STRESS_USER_CASES } from "../src/server/tracks/v4/stress-user-fixtures.js";
...
const taxonomy = runTaxonomyCoverageHarnessV4(TRACK_V4_STRESS_USER_CASES);
const compileResults = TRACK_V4_STRESS_USER_CASES.flatMap((benchmarkCase) => compileBenchmarkCaseV4(benchmarkCase));
const endToEnd = runEndToEndTrackHandlingHarnessV4(TRACK_V4_STRESS_USER_CASES);

console.log(JSON.stringify({
  suite: "stress-user",
  cases: TRACK_V4_STRESS_USER_CASES.length,
  taxonomy: {
